  ...
  function addColours() {
    for (let i = 0; i < squares.length; i++) {
      if (squares[i].innerHTML == 0)
        squares[i].style.backgroundColor = "#022851";
      else if (squares[i].innerHTML == 2)
        squares[i].style.backgroundColor = "#ffbf00";
      else if (squares[i].innerHTML == 4)
        squares[i].style.backgroundColor = "#000000";
      else if (squares[i].innerHTML == 8)
        squares[i].style.backgroundColor = "#ffbe99";
      else if (squares[i].innerHTML == 16)
        squares[i].style.backgroundColor = "#f22851";
      else if (squares[i].innerHTML == 32)
        squares[i].style.backgroundColor = "#ffbe98";
      else if (squares[i].innerHTML == 64)
        squares[i].style.backgroundColor = "#000000";
      else if (squares[i].innerHTML == 128)
        squares[i].style.backgroundColor = "#ffbe97";
      else if (squares[i].innerHTML == 256)
        squares[i].style.backgroundColor = "#f22851";
      else if (squares[i].innerHTML == 512)
        squares[i].style.backgroundColor = "#ffbe96";
      else if (squares[i].innerHTML == 1024)
        squares[i].style.backgroundColor = "#000000";
      else if (squares[i].innerHTML == 2048)
        squares[i].style.backgroundColor = "#ffbe95";
    }
  }
